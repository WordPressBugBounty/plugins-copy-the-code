...
class Deal extends Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        wp_enqueue_style(
            'ctc-el-deal',
            CTC_URI . 'includes/elementor/widgets/deal/style.css',
            [],
            CTC_VER,
            'all'
        );
        wp_enqueue_script(
            'ctc-el-deal',
            CTC_URI . 'includes/elementor/widgets/deal/script.js',
            [],
            CTC_VER,
            true
        );
    ...
    protected function _register_controls() {
        $this->start_controls_section( 'image_section', [
            'label' => esc_html__( 'Deal Image', 'ctc' ),
        ] );
        ...
        $this->add_control( 'heading', [
            ...
            'default' => esc_html__( 'Get up to 10% off on all products', 'ctc' ),
        ] );
        $this->end_controls_section();
        ...
        $this->start_controls_section( 'button_section', [
            'label' => esc_html__( 'Button', 'ctc' ),
        ] );
        // Button Text.
        $this->add_control( 'button_text', [
            'label'   => esc_html__( 'Button Text', 'ctc' ),
            'type'    => Controls_Manager::TEXT,
            'default' => esc_html__( 'Get Deal', 'ctc' ),
        ] );
        // Button Link.
