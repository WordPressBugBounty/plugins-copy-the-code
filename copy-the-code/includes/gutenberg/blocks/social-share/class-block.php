...
class Social_Share {
	...
	public function render( $attributes = [], $content = '', $block = null ) {
		$label      = $attributes['label'] ?? esc_html__( 'Share on:', 'ctc' );
		...
		<div <?php echo $wrapper_attributes; // phpcs:ignore ?>>
			...
			<?php endif; ?>
			<?php if ( $whatsapp ) : ?>
				<a class="ctc-social-share__whatsapp" href='https://api.whatsapp.com/send?text=<?php echo esc_attr( $post_content ); ?>%0A<?php echo esc_url( $link ); ?>' target='_blank' rel='noopener noreferrer'>
			...
			<?php endif; ?>
			<?php if ( $facebook ) : ?>
				<a class="ctc-social-share__facebook" href='https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url( $link ); ?>&quote=<?php echo esc_attr( $post_content ); ?>' target='_blank' rel='noopener noreferrer'>
			...
			<?php endif; ?>
			<?php if ( $twitter ) : ?>
				<a class="ctc-social-share__twitter" href='https://twitter.com/intent/tweet?text=<?php echo esc_attr( $post_content ); ?>&url=<?php echo esc_url( $link ); ?>' target='_blank' rel='noopener noreferrer'>
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
